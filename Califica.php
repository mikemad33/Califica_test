...
<? 
	...
	or die("<br>Fall� el query:<br><pre> $q </pre><br>Error:". mysqli_error());
...
?>
<br><br>
Cuestionario para evaluar al m�dico: <strong><font size="+2"><?php echo $myrow["Nombre"]." ".$myrow["Ap_Paterno"]." ".$myrow["Ap_Materno"] ?></font> </strong><br><br>
